        ...
        <main>
            <section className="h-screen w-full flex flex-row justify-center items-left p-20">
                <div className="relative flex flex-col justify-center items-start">
                    ...
                    <a href="#" className='absolute bg-white text-black font-lexend py-2 px-4 rounded-sm text-xl bottom-14 hover:bg-gray-300 transition-all duration-200'>Buy here!</a>
                </div>
                <System />
            </section>
            <section className="h-screen w-full flex flex-col gap-14 justify-center items-center text-white">
                ...
                <div className="flex gap-4">
                    <article className="flex flex-col  h-80 items-start justify-center w-80 p-6 text-pretty gap-6 border-2 border-opacity-25 border-white">
                        <img src={robot} />
                    ...
                    <article className="flex flex-col h-80 bg-gray-900 items-start justify-center w-80 p-6 text-pretty gap-6">
                        <img src={warranty} />
            ...
            >
                <div>
                    <h3 className="text-6xl font-semibold">23M</h3>
                    <small className="text-sm text-gray-100">Total sells</small>
                </div>
                <div>
                    <h3 className="text-6xl font-semibold">23k+</h3>
                    <small>Sells per day</small>
                </div>
                <div>
                    <h2 className="text-4xl font-semibold text-balance">Most important brand of telescopes</h2>
                </div>
            </section>
